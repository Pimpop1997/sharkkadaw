...
const bgFiles = [
  ...
  const messages = [
    "ก็บอกว่าเว็บล็อคไง 😑",
    "ใส่รหัสผิดอีกแล้วนะ... หรือไม่มีรหัสเลย? 🤔",
    "นี่มันเว็บลับสุดยอด! ปลดล็อคไม่ได้หรอก 🕵️‍♂️",
    "ลองอีกครั้งก็ได้... แต่ผลก็เหมือนเดิม 😅",
    "ระบบ AI ป้องกันการปลดล็อคเรียบร้อยแล้ว 🤖",
    "คุณคิดว่าแค่กดปุ่มจะปลดล็อคได้เหรอ? ฮ่าๆๆ 😂",
    "ยังไงก็ล็อคอยู่ดี! 🔐"
  ];
